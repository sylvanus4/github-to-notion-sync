...
class ConfigManager:
    ...
    def _load_config_files(self):
        ...
        try:
            ...
            if webhook_events_path.exists():
                with open(webhook_events_path, 'r', encoding='utf-8') as f:
    ...
    def load_graphql_query(self, query_name: str) -> Optional[str]:
    ...
    def validate_configuration(self) -> list[str]:
        ...
        required_vars = [
            "notion_token", "notion_db_id", "github_token", 
            "github_org", "github_project_number", "webhook_secret"
        ]
