...
class LoggerManager:
    ...
    def log_api_call(self, logger: logging.Logger, service: str, method: str, 
    ...
    def log_sync_event(self, logger: logging.Logger, event_type: str, 
                      item_id: str, action: str, success: bool = True, 
    ...
    def log_rate_limit(self, logger: logging.Logger, service: str, 
                      remaining: int, reset_time: Optional[datetime] = None):
    ...
    def log_webhook_event(self, logger: logging.Logger, event_type: str, 
                         action: str, item_id: Optional[str] = None,
                         repository: Optional[str] = None, **kwargs):
