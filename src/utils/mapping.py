...
class FieldMapper:
    ...
    def validate_field_mapping(self, field_name: str, value: Any) -> bool:
        ...
        try:
            ...
            logger.exception(f"Error validating field '{field_name}': {e}")
            return False
    ...
    def transform_value(self, field_name: str, value: Any) -> Any:
        ...
        try:
            ...
            if field_type in {"select", "status"}:
                if value is None:
                    return ""
            ...
            logger.exception(f"Error transforming value for field '{field_name}': {e}")
            return value
    ...
    def build_filter_for_github_id(self, github_node_id: str) -> dict[str, Any] | None:
        ...
        return {"property": github_id_property, "rich_text": {"equals": github_node_id}}
