...
description: >-
  ...
  "태스크 동기화", "페이퍼클립 브릿지", "todo paperclip sync", or any request to synchronize
  work items between mission-control and Paperclip. Do NOT use for
  Paperclip-only task management (use paperclip-tasks). Do NOT use for
