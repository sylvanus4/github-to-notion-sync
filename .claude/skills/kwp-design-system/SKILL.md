...
description: >-
  Design system tokens and patterns for the frontend — Refined Swiss.
  Reference this rule when creating or editing any UI component. Do NOT use
  for tasks outside the design domain. Korean triggers: "디자인 시스템", "디자인 토큰".
---
