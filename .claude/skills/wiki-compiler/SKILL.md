...
name: wiki-compiler
description: >-
  Expert agent for the Knowledge Builder Team. Compiles extracted content into
  interconnected wiki articles with cross-references, backlinks, and
  hierarchical directory structure. Produces the wiki's article files and
  index metadata. Invoked only by knowledge-builder-coordinator.
---
