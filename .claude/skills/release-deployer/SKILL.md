...
description: >-
  ...
  deployment", "Thursday deploy", "release deploy", "promote RC image", "목요일
  배포", "릴리즈 배포", "release-deployer", or during the Thursday deployment
  pipeline. Do NOT use for Tuesday collection (use release-collector),
  Wednesday QA (use release-qa-gate), or hotfix deployment (use
  hotfix-manager).
---
