---
name: ai-trader-setup
description: >-
  Register, authenticate, and verify connectivity with the AI-Trader platform
  (ai4trade.ai). Korean triggers: "AI-Trader 설정", "AI-Trader 연결", "AI-Trader
  인증", "ai4trade 로그인", "AI-Trader 등록".
---
