...
description: >-
  Quick prerequisite check at session start: verify environment, tools, API
  keys, data freshness, and pending items before productive work begins.
  Prevents wasted cycles on misconfigured environments.
---
