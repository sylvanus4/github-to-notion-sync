...
description: >-
  Write new memories to MemKraft with mandatory provenance tagging (source,
  confidence, timestamp). Validates against existing memory to prevent
  duplication. Routes to the appropriate MemKraft subdirectory based on
  content type.
---
