---
name: gpu-resource-inspector
description: >-
  Inspect GPU resource allocation, utilization, and waste across Kubernetes
  clusters. Supports 5 workflow modes that progressively deepen analysis from
  cluster-level overview to actionable reclamation recommendations.
---
