...
description: >-
  ...
  culture and features for brand growth. Use when the user asks to activate
  the Tiktok Strategist agent persona or references agency-tiktok-strategist.
  Do NOT use for project-specific code review or analysis (use the
  corresponding project skill if available). Korean triggers: "리뷰", "빌드",
  "시장", "스킬".
---
