...
description: >-
  ...
  incident-lifecycle-manager for approval patterns. Use when the user asks to
  find idle resources, cleanup orphaned resources, waste report, unused
  resource scan, cloud cleanup plan, or needs to identify and plan removal of
  unused cloud resources. Do NOT use for compute rightsizing only (use
  ...
  Korean triggers: 유휴 리소스, 고아 리소스, 클라우드 정리, 낭비 비용 분석, 리소스 정리 계획.
