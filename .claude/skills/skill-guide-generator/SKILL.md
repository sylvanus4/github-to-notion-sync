...
description: >-
  ...
  "skill-guide-sync", "find undocumented skills", "update skill docs", "스킬
  문서화", "스킬 가이드 동기화", "문서화 안 된 스킬", or wants to ensure all skills have
  corresponding guide entries. Do NOT use for creating new skills from scratch
  (use create-skill), optimizing skill quality (use skill-optimizer), or
  writing general documentation (use technical-writer).
---
