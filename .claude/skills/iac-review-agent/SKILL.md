...
description: >-
  ...
  "review infrastructure code", "IaC review", "validate infra changes", "인프라
  코드 리뷰", "IaC 검증", "iac-review-agent", or any unified IaC validation. Do NOT
  use for application code review (use deep-review), CI/CD pipeline review
  (use sre-devops-expert), or single-tool validation (use the specific
  validator skill directly).
