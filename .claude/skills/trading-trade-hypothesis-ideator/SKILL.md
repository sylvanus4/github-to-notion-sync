...
description: >-
  ...
  "rank hypothesis cards", "strategy experiment design", "kill criteria for
  trades", "가설 카드 생성", "트레이드 가설", "실험 설계", or has structured input and wants
  ranked hypothesis cards with experiment designs and optional strategy.yaml
  export. Do NOT use for strategy backtesting (use trading-backtest-expert).
  Do NOT use for daily signals (use daily-stock-check).
---
