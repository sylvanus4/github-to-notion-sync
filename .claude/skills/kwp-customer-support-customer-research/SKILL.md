...
description: >-
  ...
  bases, and connected sources, then synthesize a confidence-scored answer.
  Use when a customer asks a question you need to investigate, when building
  background on a customer situation, or when you need account context. Do NOT
  use for tasks outside the customer domain. Korean triggers: "리서치", "빌드",
  "검색", "문서".
---
