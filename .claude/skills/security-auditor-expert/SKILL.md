...
description: >-
  Expert agent for the Code Ship team. Performs security-focused audit
  covering OWASP Top 10, secret detection, dependency vulnerabilities, and
  LLM-specific security patterns. Invoked only by code-ship-coordinator.
---
