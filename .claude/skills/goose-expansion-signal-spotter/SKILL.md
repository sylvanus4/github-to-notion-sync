---
name: goose-expansion-signal-spotter
description: >-
  Identify signals that indicate an existing customer is ready for upsell or
  expansion — usage pattern changes, team growth, new use cases, feature
  requests, and engagement spikes. Produces a scored list of expansion-ready
  accounts with recommended expansion plays. Pure reasoning skill.
---
