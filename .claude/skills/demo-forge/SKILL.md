...
description: >-
  ...
  demo", "showcase changes", "데모 생성", "변경사항 데모", "stakeholder demo", "show
  what changed", or wants to present code changes to non-technical
  stakeholders. Do NOT use for static architecture diagrams (use
  visual-explainer), text-only release notes (use pr-review-captain), or video
