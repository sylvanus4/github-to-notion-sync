...
description: >-
  Analyzes market breadth using Monty's Uptrend Ratio Dashboard to diagnose
  market environment. Generates 0-100 composite score from 5 components. Use
  when the user asks "market breadth healthy", "how broad is the rally",
  "uptrend ratios", "market participation", "exposure guidance based on
  breadth", "마켓 브레드스", "업트렌드 비율", "시장 참여도". Do NOT use for daily stock signals
  (use daily-stock-check). Do NOT use for market top risk assessment (use
  trading-market-top-detector).
---
