...
description: >-
  ...
  view", "시장 종합 분석", "시장 인텔리전스", "트레이딩 인텔", "종합 시장 분석", or wants multiple
  market perspectives combined into one report. Do NOT use for
  single-perspective analysis (use the specific analyst skill directly). Do
  NOT use for daily stock screening pipeline (use today). Do NOT use for
