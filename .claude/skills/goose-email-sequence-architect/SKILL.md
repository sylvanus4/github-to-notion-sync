---
name: goose-email-sequence-architect
description: >-
  Design multi-step email sequences for any use case — onboarding, nurture,
  cold outreach, reactivation, upsell, or event follow-up. Each email gets
  subject lines, preview text, body structure, CTA, send timing, and branching
  logic based on open/click behavior. Pure reasoning skill.
---
