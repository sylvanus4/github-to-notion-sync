...
description: >-
  ...
  lead discovery, enrichment, account research, call prep, outreach,
  competitive intelligence, asset generation, and deal tracking across Apollo,
  Common Room, and native sales skills (19 skills total). Use when the user
  asks to "run sales pipeline", "sales harness", "lead-to-deal pipeline", "영업
  하네스", "세일즈 파이프라인", "sales-harness", or wants end-to-end sales operations. Do
  NOT use for individual sales operations (invoke kwp-sales-* directly). Do
  NOT use for marketing campaigns (use marketing-harness).
---
