...
description: >-
  ...
  Deployment target is user's choice: Docker/K8s, serverless, PaaS, or any
  Node.js host. Use when the user asks to "build a Slack bot", "create a Slack
  agent", "deploy a Slack app", "slack-agent", or mentions Slack bot
  development. Do NOT use for general Slack messaging (use
  kwp-slack-slack-messaging), Slack search (use kwp-slack-slack-search).
  Korean triggers: "슬랙 봇", "봇 만들기", "슬랙 앱".
