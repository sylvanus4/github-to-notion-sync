...
description: >-
  ...
  mental models, map expert disagreements and consensus, run
  deep-understanding quizzes with gap analysis, generate study artifacts
  (debate podcast, flashcards, quiz, mind map, study guide). Use when the user
  asks to "deep learn", "accelerated learning", "compress learning", "mental
  models for", "48-hour learning", "NLM deep learn", "가속 학습", "멘탈 모델 추출", "심층
  이해 퀴즈", or any request to deeply learn a subject using NotebookLM. Do NOT
  use for ad-hoc studio_create -- use notebooklm-studio. Do NOT use for
  product discovery -- use nlm-discovery-lab. Do NOT use for local StudyVault
  quizzing -- use docs-tutor.
---
