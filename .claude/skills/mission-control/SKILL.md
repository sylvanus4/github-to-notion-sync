...
description: >-
  ...
  results, and track progress. Use when the user asks for a full review,
  release prep, quality audit, incident response, or any task spanning
  multiple domains, or invokes workflow commands like /full-quality-audit,
  /feature-pipeline. Do NOT use for single-domain tasks that one specific
  skill can handle alone. Korean triggers: "감사", "리뷰", "파이프라인", "워크플로우".
---
