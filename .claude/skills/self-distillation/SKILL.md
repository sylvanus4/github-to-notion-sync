...
description: >-
  Guides extraction of the user's own expression style, mental models, and
  decision habits from their writings, chat logs, and public social text into
  a reusable persona skill. Use when the user wants an AI layer that "thinks
  like me" with explicit, revisable rules—not when distilling a third party
  (use nuwa).
---
