---
name: tab-tradingview-screener
description: >-
  Cross-check native screener results against TradingView MCP screener
  (fiale-plus) with 100+ fields and 14 pre-built strategies. Use when
  cross-checking screener, 'TV screener', 'TradingView 스크리너',
  'tab-tradingview-screener'. Do NOT use for native screening only (use
  tab-screening), TA cross-validation (use tab-tradingview-ta), or Pine Script
  generation (use pine-script-generator).
---
