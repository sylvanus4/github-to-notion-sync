...
description: >-
  ...
  this vendor", "compare vendors", "vendor review", "should we renew", "RFP",
  or when the user is making procurement or vendor decisions. Do NOT use for
  tasks outside the operations domain. Korean triggers: "리뷰", "출시".
---
