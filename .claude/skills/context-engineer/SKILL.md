...
description: >-
  ...
  maintenance, context packages per analysis type, knowledge graph updates,
  and AI agent context window optimization. Ensures AI agents always have full
  ...
  package", "optimize agent context", "context engineer", "컨텍스트 관리", "MEMORY
  업데이트", "지식 아키텍처", or wants to improve how AI agents understand the project.
