---
name: tab-market-breadth
description: >-
  Refresh and query market breadth data via POST /market-breadth/refresh and
  GET /market-breadth/latest, /trend, /composite, /alerts. Use when refreshing
  breadth, 'market breadth refresh', '마켓 브레드스 갱신', 'tab-market-breadth'. Do
  NOT use for market environment analysis (use tab-market-environment), Turtle
