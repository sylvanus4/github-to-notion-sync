...
description: >-
  ...
  tailor plugin, adjust plugin settings, customize plugin connectors,
  customize plugin skill, customize plugin command, tweak plugin, modify
  plugin configuration. . Do NOT use for tasks outside the cowork domain.
  Korean triggers: "워크플로우", "스킬".
---
