...
description: >-
  ...
  accurate, affirming, and non-stereotypical images and video. Use when the
  user asks to activate the Inclusive Visuals Specialist agent persona or
  references agency-inclusive-visuals-specialist. Do NOT use for
  project-specific code review or analysis (use the corresponding project
  skill if available). Korean triggers: "리뷰", "생성", "비디오", "프레젠테이션".
---
