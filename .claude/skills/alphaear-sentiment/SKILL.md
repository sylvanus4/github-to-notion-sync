...
description: >-
  ...
  Use when the user needs to determine sentiment (positive/negative/neutral)
  and score of financial text. Do NOT use for news aggregation (use
  alphaear-news). Do NOT use for trading signal generation (use
  daily-stock-check). Do NOT use for market prediction (use
  alphaear-predictor). Korean triggers: "감성 분석", "감성 점수", "긍정 부정", "FinBERT".
---
