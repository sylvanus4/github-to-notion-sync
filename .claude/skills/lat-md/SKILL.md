...
name: lat-md
description: >-
  Manage the lat.md code architecture knowledge graph — run lat check for
  drift detection, lat search for semantic architecture queries, lat refs for
  cross-referencing, and maintain @lat annotations in source code.
---
