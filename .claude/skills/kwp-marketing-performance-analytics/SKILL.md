...
description: >-
  ...
  optimization recommendations. Use when building performance reports,
  reviewing campaign results, analyzing channel metrics (email, social, paid,
  SEO), or identifying what's working and what needs improvement. Do NOT use
  for tasks outside the marketing domain. Korean triggers: "성능", "리뷰", "빌드",
  "분석".
---
