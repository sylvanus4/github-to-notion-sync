...
description: >-
  Clone, install, configure, and operate the Gov-chat-bot (SmartBot KR) — an
  open-source KakaoTalk-integrated AI consultation chatbot platform. Handles
  full lifecycle from GitHub clone through Docker deployment, admin setup,
  FAQ/document management, KakaoTalk Open Builder integration, homepage widget
