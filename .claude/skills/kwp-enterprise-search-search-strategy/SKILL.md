...
description: >-
  ...
  ambiguity and fallback strategies. Do NOT use for tasks outside the
  enterprise domain. Korean triggers: "검색".
---
...
**User says:** "I need help with enterprise search search strategy"
