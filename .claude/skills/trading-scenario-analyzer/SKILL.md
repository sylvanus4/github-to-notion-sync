...
description: >-
  Analyze news headlines for 18-month investment scenarios. Orchestrates
  scenario-analyst (main analysis) and strategy-reviewer (second opinion)
  agents to produce comprehensive reports with 1st/2nd/3rd-order impacts,
  recommended stocks, and review feedback in Japanese. Use for "scenario
  analysis", "headline scenario", "18-month outlook", "シナ리오 분석", "뉴스 시나리오",
  "18개월 전망". Do NOT use for daily stock signals (use daily-stock-check). Do
  NOT use for AlphaEar analysis (use alphaear-deepear-lite). Do NOT use for
