...
description: >-
  ...
  "check trust scores", "generate keypair", "threat scan", "SEFO 거버넌스", "스킬
  서명", "신뢰 점수", "위협 탐지", "프로비넌스 검증", or any trust and security operation on
  skills. Do NOT use for task routing (use sefo-orchestrator), federation sync
  (use sefo-federation), or general security review (use security-expert).
---
