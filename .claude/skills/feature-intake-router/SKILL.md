...
description: >-
  Automates feature request intake from Slack forms, auto-classifies by
  product area, creates Notion tickets with stakeholder lists, suggests RICE
  priority, detects duplicates, and notifies PM channel. Use when "feature
  intake", "기능 요청 접수", "request routing". Do NOT use for PRD generation (use
  prd-research-factory), backlog scoring (use /backlog-triage). Korean
  triggers: "기능 요청 접수", "요청 라우팅", "피처 인테이크".
---
