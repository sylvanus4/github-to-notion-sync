...
description: >-
  Enhanced automatic persona distillation: improved mental-model
  identification, richer expression DNA, and stricter handling of evidence and
  contradictions compared to auto-distill v1. Use when you want a strong
  default from documents without full manual Nuwa iteration—not when you
  insist on hand-guided every line (use nuwa).
---
