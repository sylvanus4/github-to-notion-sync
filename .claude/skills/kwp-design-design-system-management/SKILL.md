...
description: >-
  Manage design tokens, component libraries, and pattern documentation.
  ...
  Do NOT use for this project's design audit or React component review —
  prefer design-architect or frontend-expert skill. Korean triggers: "설계",
  "감사", "리뷰", "문서".
---
