---
name: crg-build-graph
description: >-
  Build or update the code-review-graph AST-based knowledge graph. Supports
  full rebuild, incremental update from Git diff, and status checks.
---
