...
description: >-
  Poll the AI-Trader platform heartbeat endpoint for notifications, pending
  tasks, copy-trade alerts, and platform announcements. Uses a pull-based
  polling mechanism. Korean triggers: "AI-Trader 알림 확인", "AI-Trader 하트비트",
  "AI-Trader 대기 작업", "ai4trade 알림", "AI-Trader 폴링".
---
