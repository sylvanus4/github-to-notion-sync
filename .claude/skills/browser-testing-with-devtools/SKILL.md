...
description: >-
  ...
  real runtime data via Chrome DevTools MCP. Do NOT use for Playwright E2E
  test suites (use e2e-testing). Do NOT use for MCP-based interactive browser
  sessions (use cursor-ide-browser MCP).
---
