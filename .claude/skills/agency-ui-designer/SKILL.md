...
description: >-
  ...
  identity. Use when the user asks to activate the Ui Designer agent persona
  or references agency-ui-designer. Do NOT use for project-specific design
  audit (use design-architect). Korean triggers: "감사", "생성", "설계".
---
