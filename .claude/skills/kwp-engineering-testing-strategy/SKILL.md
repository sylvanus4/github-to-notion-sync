...
description: >-
  ...
  "test strategy for", "write tests for", "test plan", "what tests do we
  need", or when the user needs help with testing approaches, coverage, or
  test architecture. Do NOT use for this project's pytest/Vitest/Playwright
