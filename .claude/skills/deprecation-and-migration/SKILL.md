...
description: >-
  ...
  when deciding whether to maintain or sunset existing code. Do NOT use for
  dependency CVE scanning (use dependency-auditor). Do NOT use for API
  versioning review (use backend-expert).
---
