...
description: >-
  Detect PRs and issues needing discussion (stale reviews, conflicting
  comments, blocked items) and proactively schedule 1:1 feedback meetings with
  relevant parties. Use when the user asks to "schedule feedback meetings",
  "find items needing discussion", "피드백 미팅 잡아줘", "리뷰 미팅 스케줄",
  "feedback-meeting-scheduler", or wants automated meeting proposals from
  sprint activity. Do NOT use for general meeting scheduling (use
