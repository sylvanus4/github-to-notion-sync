...
description: >-
  ...
  Triggers: "call ATG", "ATG route", "gateway call", "ATG 호출", "게이트웨이 라우팅",
  "atg-client". Do NOT use for tools not supported by ATG (Figma, Browser,
  Daiso, Context7, NotebookLM, HuggingFace — use their MCP servers directly).
  Do NOT use for ATG server development (edit Go code directly). Do NOT use
  for skill optimization analysis (use atg-skill-engineer).
---
