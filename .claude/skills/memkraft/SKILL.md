...
name: memkraft
description: >-
  Personal memory orchestrator: read, write, query, and manage tiered personal
  memory (HOT/WARM/COLD) with provenance tags, session continuity, and
  unresolved item tracking. Wraps existing `recall` skill with MemKraft
  semantics.
---
