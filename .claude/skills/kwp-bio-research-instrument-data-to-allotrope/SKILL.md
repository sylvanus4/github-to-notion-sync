...
description: >-
  ...
  Python code for data engineers. Common triggers include converting
  instrument files, standardizing lab data, preparing data for upload to
  LIMS/ELN systems, or generating parser code for production pipelines. Do NOT
  use for tasks outside the bio domain. Korean triggers: "리서치", "데이터",
  "파이프라인", "스킬".
