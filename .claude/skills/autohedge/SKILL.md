...
name: autohedge
description: >-
  Install, configure, and operate AutoHedge — a Swarms-based autonomous
  multi-agent hedge fund system with 5 specialized AI agents (Director, Quant,
  Sentiment, Risk Management, Execution). Orchestrates end-to-end trading
  workflows from market analysis through order execution on Solana DEX venues.
