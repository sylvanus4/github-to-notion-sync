---
name: content-auto-gate
description: >-
  Automated content quality gate that scores AI-generated stock content drafts
  on 5 dimensions (accuracy, compliance, tone, completeness, originality) and
  auto-approves drafts scoring above a configurable threshold. Drafts below
  the threshold are rejected with actionable feedback. Replaces manual Slac
---
