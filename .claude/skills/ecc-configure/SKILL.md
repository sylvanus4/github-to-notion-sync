...
name: ecc-configure
description: >-
  Configure and customize Everything Claude Code skills for a specific
  project. Guides through selecting relevant skills, installing rules,
  verifying paths, and optimizing installed files. Use when setting up ECC
  skills for a new project or auditing existing ECC configuration. Do NOT use
  for general skill creation (use anthropic-skill-creator). Do NOT use for
  Cursor settings (use update-cursor-settings). Korean triggers: "ECC 설정",
  "ECC 구성".
---
