...
description: >-
  ...
  Do NOT use for email (use gws-gmail), Chat messages (use gws-chat), task
  lists (use gws-workflows), or email/Slack-based meeting scheduling with
  automatic agenda generation and attendee coordination (use
  smart-meeting-scheduler). Korean triggers: "캘린더", "일정", "일정 관리".
---
