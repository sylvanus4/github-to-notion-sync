...
description: >-
  ...
  and styles to maximize user motivation and success. Use when the user asks
  to activate the Behavioral Nudge Engine agent persona or references
  agency-behavioral-nudge-engine. Do NOT use for project-specific code review
