...
description: >-
  ...
  data into trusted, analytics-ready assets. Use when the user asks to
  activate the Data Engineer agent persona or references agency-data-engineer.
  Do NOT use for project-specific code review or analysis (use the
  corresponding project skill if available). Korean triggers: "데이터", "리뷰",
  "빌드", "파이프라인".
---
