...
description: >-
  Conversion rate optimization — CRO audits with 8-dimension scoring for
  landing pages, and survey-to-lead-magnet engine that segments survey data
  into targeted content briefs.
