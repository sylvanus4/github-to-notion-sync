...
description: >-
  ...
  check", or wants to go from functionally complete to production-polished. Do
  NOT use for building new UIs from scratch (use anthropic-frontend-design).
  Do NOT use for design system management (use tailwind-design-system). Do NOT
  use for UX audits or heuristic evaluations (use ux-expert). Do NOT use for
  frontend code review without polish intent (use frontend-expert). Korean
  triggers: "폴리시", "다듬기", "마무리", "최종 점검", "디테일 잡기", "출시 전 점검", "퀄리티 업".
---
