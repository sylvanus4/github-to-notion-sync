...
name: rr-cs-support
description: >-
  Role Replacement Case Study: Customer Support Lead — Pipeline + Supervisor
  pattern for the full ticket lifecycle from triage through resolution,
  knowledge capture, and batch feedback analysis with RICE-scored executive
  reports. Thin harness composing customer-support-harness,
  customer-feedback-processor, and 5 kwp-customer-support-* skills into a
  unified CS-lead role pipeline with MemKraft-powered ticket history,
  proactive trend detection, SLA tracking, and automated Slack escalation
  routing.
---
