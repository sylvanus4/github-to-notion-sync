...
description: >-
  Expert project manager specializing in experiment design, execution
  ...
  experimentation and rigorous analysis. Use when the user asks to activate
  the Experiment Tracker agent persona or references
  agency-experiment-tracker. Do NOT use for project-specific code review or
  analysis (use the corresponding project skill if available). Korean
  triggers: "리뷰", "테스트", "설계", "스킬".
---
