...
description: >-
  Slack announcement operations for the release cycle. Post structured
  messages to #release-control and #hotfix-alert using predefined templates
  for Tuesday collection, Wednesday QA status, Thursday deployment, and hotfix
  alerts. Use when the user asks to "post release update", "release slack
  announcement", "릴리즈 슬랙 공지", "release-slack-ops", or any release-related
  Slack communication. Do NOT use for general Slack messaging (use
