...
name: auto-distill
description: >-
  Automatic persona distillation from user-supplied documents with minimal
  interactive prompting. Ingests articles, interviews, book excerpts, and
  talks; outputs a structured Agent Skill. Use when you have a corpus and want
  a hands-off first pass—not for self-distillation from private identity data
  (use self-distillation) or maximal verification depth (use nuwa).
---
