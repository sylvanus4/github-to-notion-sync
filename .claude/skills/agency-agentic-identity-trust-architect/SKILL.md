...
description: >-
  ...
  autonomous AI agents operating in multi-agent environments. Ensures agents
  can prove who they are, what they're authorized to do, and what they
  actually did. Use when the user asks to activate the Agentic Identity Trust
  Architect agent persona or references
  agency-agentic-identity-trust-architect. Do NOT use for project-specific
  code review or analysis (use the corresponding project skill if available).
  Korean triggers: "리뷰", "설계", "스킬".
---
