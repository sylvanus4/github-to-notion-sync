...
description: >-
  ...
  GitHub activity", "sprint digest", "GitHub 스프린트 요약", "깃헙 활동 정리", "밤새 PR 정리",
  "github-sprint-digest", or wants a daily development activity summary across
  projects. Do NOT use for creating GitHub issues from commits (use
  commit-to-issue), PR review (use pr-review-captain), or full CI pipeline
