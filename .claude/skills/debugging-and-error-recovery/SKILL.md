...
description: >-
  ...
  rather than guessing. Do NOT use for project-specific 3-agent parallel
  diagnosis (use diagnose). Do NOT use for Cursor-specific systematic
  debugging (use sp-debugging).
---
