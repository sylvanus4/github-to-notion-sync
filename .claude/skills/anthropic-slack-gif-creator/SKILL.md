...
description: >-
  ...
  tools, and animation concepts. Use when users request animated GIFs for
  Slack like "make me a GIF of X doing Y for Slack." Do NOT use for static
  image creation (use anthropic-canvas-design) or general Slack messaging (use
