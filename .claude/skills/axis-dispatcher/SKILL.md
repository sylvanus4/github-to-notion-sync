...
description: >-
  ...
  "full axis routine", "axis-dispatcher", "6축 디스패처", "전체 축 실행", "morning
  routine", "evening routine", or wants to execute the complete personal
  assistant pipeline. Do NOT use for running individual axes (invoke the
  specific axis-* skill). Do NOT use for the old daily-am-orchestrator (this
  replaces it at the axis level).
---
