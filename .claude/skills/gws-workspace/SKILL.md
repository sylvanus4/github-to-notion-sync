...
description: >-
  ...
  controlling Gmail, Drive, Calendar, Sheets, Docs, and Chat from the
  terminal. Use when the user asks to set up gws, configure Google Workspace
  CLI, authenticate with Google, or start the gws MCP server. Do NOT use for
  service-specific operations (use gws-gmail, gws-drive, gws-calendar,
  gws-sheets, gws-docs, or gws-chat instead). Korean triggers: "구글 워크스페이스",
  "gws 설정".
---
