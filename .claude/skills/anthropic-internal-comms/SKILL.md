...
description: >-
  ...
  reports, leadership updates, project updates, incident reports. Do NOT use
  for external marketing content (use kwp-marketing-content-creation) or
  stakeholder comms (use kwp-product-management-stakeholder-comms). Korean
  triggers: "사내 공지", "3P 업데이트", "상태 보고".
---
