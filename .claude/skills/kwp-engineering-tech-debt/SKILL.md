...
description: >-
  ...
  when the user asks about code quality, refactoring priorities, or
  maintenance backlog. Do NOT use for this project's specific refactoring
  patterns — prefer backend-expert or frontend-expert skill. Korean triggers:
  "기술 부채", "리팩토링".
---
