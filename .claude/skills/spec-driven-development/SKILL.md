...
description: >-
  ...
  are unclear, ambiguous, or only exist as a vague idea. Do NOT use for PRD
  writing with PM frameworks (use pm-execution). Do NOT use for meeting-to-PRD
  pipeline (use prd-research-factory).
---
