...
description: >-
  ...
  "compliance gate", "security compliance scan", "컴플라이언스 게이트", "보안 컴플라이언스",
  "compliance-gate", or needs unified compliance validation before deployment.
  Do NOT use for code quality review (use deep-review), individual dependency
  audits (use dependency-auditor), or IaC validation only (use
  iac-review-agent).
