...
description: >-
  Fetch read-only market intelligence snapshots from the AI-Trader platform:
  market overview, macro signals, ETF flows, grouped news, and per-symbol
  stock analysis. Korean triggers: "AI-Trader 시장 정보", "AI-Trader 매크로",
  "AI-Trader ETF", "ai4trade 시장 분석", "AI-Trader 뉴스".
---
