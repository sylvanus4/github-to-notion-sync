...
name: tab-stock-sync
description: >-
  Daily stock price sync from Yahoo Finance to PostgreSQL for all tracked
  tickers via weekly_stock_update.py script. Use when syncing prices, '주식 데이터
  동기화', 'tab-stock-sync'. Do NOT use for stock analysis (use
  daily-stock-check), CSV downloads (use stock-csv-downloader), or fundamental
  data (use tab-fundamental-sync).
---
