---
name: meta-harness-onboarding
description: >-
  Structured pre-implementation gate for harness optimization. Runs a Socratic
  conversation loop that produces a `domain_spec.md` before any code-level
  optimization begins. Adapted from Stanford IRIS Lab's ONBOARDING.md
  methodology (arXiv:2603.28052).
---
