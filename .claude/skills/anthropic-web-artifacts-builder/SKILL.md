...
description: >-
  Build complex HTML artifacts with React, Tailwind, shadcn/ui. Use for
  complex artifacts requiring state management, routing, or shadcn/ui
  components. Do NOT use for frontend code review (use frontend-expert), UX
  audits (use ux-expert), or simple static HTML (use
  anthropic-frontend-design). Korean triggers: "웹 아티팩트", "React 컴포넌트",
  "shadcn".
---
