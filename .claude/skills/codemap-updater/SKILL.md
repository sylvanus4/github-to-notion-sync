...
description: >-
  Generate and maintain a structured codebase map (CODEMAP.md) that gives
  agents quick navigation context — directory tree, entry points, architecture
  layers, module dependencies, community clusters, and hot-file index.
  Leverages code-review-graph MCP for AST-verified module boundaries,
  community detection, and execution flow mapping when available.
---
