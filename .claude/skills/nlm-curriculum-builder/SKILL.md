...
description: >-
  ...
  curriculum-designer persona, produce syllabi, per-module lesson plans, and 7
  artifact types (slides, audio, quiz, flashcards, study guide, video, mind
  map) per module — then package and distribute. Use when the user asks to
  "build curriculum", "create course", "design a course", "lecture
  curriculum", "syllabus generator", "curriculum builder", "NLM curriculum",
  "커리큘럼 구축", "강의 설계", "교수요목 생성", "강좌 만들기", "nlm-curriculum-builder", or any
  request to build a multi-module academic or professional curriculum using
  NotebookLM. Do NOT use for personal accelerated learning -- use
  nlm-deep-learn. Do NOT use for ad-hoc studio_create on existing notebooks --
  use notebooklm-studio. Do NOT use for single-topic slide generation -- use
  nlm-slides. Do NOT use for product discovery frameworks -- use
  nlm-discovery-lab.
---
