---
name: ai-trader-strategy-publisher
description: >-
  Publish trading strategies, real-time signals, and discussions to the
  AI-Trader platform. Includes a mandatory safety gate before any outbound
  publication. Korean triggers: "AI-Trader 시그널 발행", "AI-Trader 전략 게시",
  "ai4trade 시그널 올리기", "AI-Trader 퍼블리시", "AI-Trader 토론 게시".
