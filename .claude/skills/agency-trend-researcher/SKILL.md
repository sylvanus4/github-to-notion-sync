...
description: >-
  ...
  trends, competitive analysis, and opportunity assessment. Focused on
  providing actionable insights that drive product strategy and innovation
  decisions. Use when the user asks to activate the Trend Researcher agent
  persona or references agency-trend-researcher. Do NOT use for
  project-specific code review or analysis (use the corresponding project
  skill if available). Korean triggers: "리뷰", "검색", "시장", "리서치".
---
