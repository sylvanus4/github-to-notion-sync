...
description: >-
  Expert agent for the Research and Report team. Performs structured analysis
  on raw research data — identifies patterns, contradictions, implications,
  and actionable insights. Invoked only by research-report-coordinator.
---
