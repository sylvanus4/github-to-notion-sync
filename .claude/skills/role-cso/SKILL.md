...
name: role-cso
description: >-
  Analyze a given topic from the CSO (Chief Strategy Officer) perspective —
  market sizing, competitive positioning, GTM strategy, business model impact,
  and scenario planning. Scores topic relevance (1-10) and produces a
  structured Korean analysis document when relevant (>= 5). Composes
  pm-market-research, pm-go-to-market, pm-product-strategy,
  kwp-marketing-competitive-analysis, workflow-miner, skill-composer,
  intent-alignment-tracker, and optionally sun-tzu-analyzer (via
  --with-sun-tzu). Use when the role-dispatcher invokes this skill with a
  topic, or when the user asks for "CSO perspective", "CSO 관점", "전략 분석",
  "market strategy impact". Do NOT use for full GTM execution (use
  pm-go-to-market), Lean Canvas only (use pm-product-strategy), or competitive
  battlecard creation (use kwp-sales-competitive-intelligence). Korean
  triggers: "CSO 관점", "전략 분석", "시장 전략 영향".
---
