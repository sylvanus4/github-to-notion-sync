...
description: >-
  Analyze a given topic from the UX Designer perspective — user experience
  impact, accessibility concerns, design system consistency, user research
  needs, and design handoff requirements. Scores topic relevance (1-10) and
  ...
  workflow-miner, and intent-alignment-tracker. Use when the role-dispatcher
  invokes this skill with a topic, or when the user asks for "UX perspective",
  "UX 관점", "디자이너 분석", "user experience impact". Do NOT use for conducting a
  full UX audit (use ux-expert), design system token management (use
  kwp-design-design-system-management), or writing UX copy (use
  kwp-design-ux-writing). Korean triggers: "UX 관점", "디자이너 분석", "사용자 경험 영향".
