...
description: >-
  ...
  when the user asks "market analysis", "market environment", "global
  markets", "trading environment", "risk-on risk-off", "market conditions",
  "investment climate", "market sentiment", "相場環境", "市場分析", "マーケット状況", "投資環境".
  Do NOT use for daily stock signals (use daily-stock-check). Do NOT use for
  AlphaEar news aggregation (use alphaear-news). Korean triggers: "시장", "분석",
  "체크", "리포트".
---
