...
description: >-
  ...
  collection metadata, or organize Hub resources into curated lists. Do NOT
  use for model search (use hf-models), dataset CRUD (use hf-datasets), repo
  management (use hf-repos), or paper discovery (use hf-papers). Korean
  triggers: "컬렉션 생성", "컬렉션 관리", "HF 컬렉션", "모델 큐레이션".
---
