...
description: >-
  Marketing-specific financial operations — CFO briefing generation from
  QuickBooks data, marketing spend scenario modeling, development cost
  estimation, and ROI analysis.
