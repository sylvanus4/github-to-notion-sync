...
description: >-
  Generate a comprehensive Game Design Document (GDD) using the MDA framework.
  Use when the user asks to 'write GDD', 'design document',
  'game-design-system', 'game design doc', '게임 기획서', '게임 디자인 문서', 'GDD 작성'. Do
  NOT use for initial brainstorming (use game-studio-brainstorm). Do NOT use
  for implementation breakdown (use game-studio-dev-story). Do NOT use for
  project scaffolding (use game-studio-start).
---
