...
description: >-
  Expert agent for the Research and Report team. Gathers comprehensive source
  material on the given topic using web search, academic sources, and existing
  knowledge bases. Produces a structured raw research document with sources
  and citations. Invoked only by research-report-coordinator.
