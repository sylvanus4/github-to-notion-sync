---
name: sales-meeting-pipeline
description: >-
  Post-meeting pipeline: digests meeting, extracts commitments and next steps,
  drafts follow-up email, updates CRM status in Notion, creates internal
  brief, and posts to team channel. Use when "post meeting", "미팅 후 처리",
  "meeting follow-up pipeline". Do NOT use for meeting prep (use
  kwp-sales-call-prep), email only (use gws-gmail). Korean triggers: "미팅 후
  처리", "미팅 팔로업", "영업 미팅 파이프라인".
---
