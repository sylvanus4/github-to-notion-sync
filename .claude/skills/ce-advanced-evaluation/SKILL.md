...
description: >-
  ...
  ai-quality-evaluator). Do NOT use for agent session evaluation metrics (use
  intent-alignment-tracker or ecc-eval-harness). Korean triggers: "LLM 판사",
  "평가 바이어스", "직접 스코어링", "페어와이즈 비교", "루브릭 생성".
---
