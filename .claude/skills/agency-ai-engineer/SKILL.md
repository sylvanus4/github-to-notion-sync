...
description: >-
  ...
  emphasis on practical, scalable solutions. Use when the user asks to
  activate the Ai Engineer agent persona or references agency-ai-engineer. Do
  NOT use for project-specific code review or analysis (use the corresponding
  project skill if available). Korean triggers: "리뷰", "배포", "빌드", "파이프라인".
---
