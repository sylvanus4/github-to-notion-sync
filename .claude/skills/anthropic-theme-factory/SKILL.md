...
description: >-
  ...
  pre-set themes with colors/fonts; apply to any artifact or generate new
  themes on-the-fly. Do NOT use for brand guidelines (use
  anthropic-brand-guidelines) or design system management (use
  kwp-design-design-system-management). Korean triggers: "생성", "설계", "리포트",
  "슬라이드".
---
