...
description: >-
  ...
  Five-phase workflow: Discovery → Component Planning → Design →
  Implementation → Review & Package. Delivers a ready-to-install .plugin file.
  Covers commands, skills, agents, hooks, and MCP integrations. Use when the
  user asks to "create a plugin", "build a plugin", "make a new plugin", or
  "develop a plugin" for Cowork. Do NOT use for tasks outside the cowork
  domain.
---
