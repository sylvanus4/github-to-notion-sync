...
description: >-
  ...
  update", "candidate pipeline", "how many candidates", "hiring status", or
  when the user discusses sourcing, screening, interviewing, or extending
  offers. Do NOT use for tasks outside the human domain. Korean triggers:
  "채용", "인사 파이프라인", "후보자".
---
