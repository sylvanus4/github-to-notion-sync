...
description: >-
  ...
  and ensures software resonates authentically across intersectional
  identities. Use when the user asks to activate the Cultural Intelligence
  Strategist agent persona or references
  agency-cultural-intelligence-strategist. Do NOT use for project-specific
  code review or analysis (use the corresponding project skill if available).
  Korean triggers: "리뷰", "검색", "리서치", "스킬".
---
