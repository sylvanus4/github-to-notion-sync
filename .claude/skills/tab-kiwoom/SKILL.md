...
name: tab-kiwoom
description: >-
  Interface with Kiwoom Securities brokerage API for real-time Korean stock
  quotes, order placement, and account management. Use when interacting with
  Kiwoom, '키움 증권', 'tab-kiwoom', 'Kiwoom API'. Do NOT use for Yahoo Finance
  stock data (use tab-stock-sync), daily stock analysis (use
  daily-stock-check), or US stock analysis (use trading-us-stock-analysis).
