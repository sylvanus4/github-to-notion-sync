...
description: >-
  ...
  for implementation, Opus for architecture). Use when planning
  agent-delegated work, choosing model tiers, or reviewing AI-generated code.
  Do NOT use for manual coding tasks. Do NOT use for workflow orchestration
  (use mission-control). Korean triggers: "에이전트 엔지니어링", "모델 라우팅".
---
