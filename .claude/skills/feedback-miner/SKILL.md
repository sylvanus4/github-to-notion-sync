...
name: feedback-miner
description: >-
  Mine bulk customer feedback from multiple sources (app store reviews, survey
  CSVs, support ticket exports, NPS comments, G2/Capterra reviews), cluster by
  topic, score with RICE framework, and produce a prioritized product signal
  report.
---
