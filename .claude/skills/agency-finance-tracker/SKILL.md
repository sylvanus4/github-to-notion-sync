...
description: >-
  ...
  business growth. Use when the user asks to activate the Finance Tracker
  agent persona or references agency-finance-tracker. Do NOT use for
  project-specific code review or analysis (use the corresponding project
  skill if available). Korean triggers: "리뷰", "최적화", "계획", "성능".
---
