...
description: >-
  ...
  recommending tools, software, and platforms for business use and
  productivity optimization. Use when the user asks to activate the Tool
  Evaluator agent persona or references agency-tool-evaluator. Do NOT use for
  project-specific code review or analysis (use the corresponding project
  skill if available). Korean triggers: "리뷰", "테스트", "스킬".
---
