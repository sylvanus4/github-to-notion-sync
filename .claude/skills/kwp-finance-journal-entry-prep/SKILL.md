...
description: >-
  ...
  amortization, fixed asset depreciation, payroll entries, revenue
  recognition, or any manual journal entry. Do NOT use for tasks outside the
  finance domain. Korean triggers: "수정", "문서".
---
