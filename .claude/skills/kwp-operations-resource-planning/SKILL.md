...
description: >-
  ...
  "capacity", "utilization", "staffing plan", "who should work on what",
  "we're stretched thin", or when the user needs help allocating people,
  budget, or time across projects and teams. Do NOT use for tasks outside the
  operations domain. Korean triggers: "최적화", "계획".
---
