---
name: goose-voice-of-customer-synthesizer
description: >-
  Pull customer language from reviews, testimonials, support tickets, and
  sales calls — then extract recurring phrases, emotional triggers, objection
  patterns, and "jobs to be done" language. Outputs a VoC dictionary that
  marketers can use to write copy that sounds like the customer, not the
  company.
---
