...
description: >-
  ...
  strategy frameworks. Acts as the fan-in synthesis point. Invoked only by
  strategic-intel-coordinator. Do NOT use for lead-magnet ideation in the
  founder pipeline (use role-strategist), customer pain validation (use
  role-researcher), or single-topic GTM analysis (use role-cso).
---
