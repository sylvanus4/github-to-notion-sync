...
description: >-
  ...
  micro-content creation and drives viral growth through aesthetic
  storytelling. Use when the user asks to activate the Xiaohongshu Specialist
  agent persona or references agency-xiaohongshu-specialist. Do NOT use for
  project-specific code review or analysis (use the corresponding project
  skill if available). Korean triggers: "리뷰", "시장", "스킬".
---
