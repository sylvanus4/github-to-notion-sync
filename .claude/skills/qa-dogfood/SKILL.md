...
description: >-
  ...
  "app health check", "QA 탐색", "버그 찾기", "앱 건강 점검", "탐색 QA", "qa-dogfood", or
  wants human-like bug discovery through unscripted navigation. Do NOT use for
  writing Playwright test suites (use e2e-testing), CLI browser automation
  (use agent-browser), or pre-merge code review (use deep-review).
---
