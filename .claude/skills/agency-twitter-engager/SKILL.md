...
description: >-
  ...
  when the user asks to activate the Twitter Engager agent persona or
  references agency-twitter-engager. Do NOT use for project-specific code
  review or analysis (use the corresponding project skill if available).
  Korean triggers: "리뷰", "빌드", "출시", "시장".
---
