...
description: >-
  ...
  or third-party data. Use when performing bank reconciliations,
  GL-to-subledger recs, intercompany reconciliations, or identifying and
  categorizing reconciling items. Do NOT use for tasks outside the finance
  domain. Korean triggers: "데이터".
---
