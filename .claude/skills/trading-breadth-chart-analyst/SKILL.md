...
description: >-
  Analyzes market breadth charts: S&P 500 Breadth Index (200-Day MA) and US
  Stock Market Uptrend Stock Ratio. Use when the user asks for "market breadth
  assessment", "breadth chart analysis", "positioning strategy", "strategic
  tactical market outlook", "마켓 브레드스", "차트 분석", "포지셔닝 전략". Do NOT use for
  daily stock signals (use daily-stock-check). Do NOT use for AlphaEar news
  aggregation (use alphaear-news).
---
