...
description: >-
  Generate entity-aware morning briefing from gbrain — active deals, recent
  meetings, people in play, and upcoming timelines. Posts a structured Slack
  thread to briefing", "entity briefing", "who's in play", "active deals",
  "gbrain morning", "gbrain-briefing", "엔티티 브리핑", "gbrain 아침", "인맥 브리핑", "활성
  딜", or wants an entity-centric morning overview. Do NOT use for daily stock
  analysis (use today). Do NOT use for general web search (use
  parallel-web-search). Do NOT use for Cognee knowledge graph queries (use
  cognee).
---
