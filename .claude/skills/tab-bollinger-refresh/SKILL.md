---
name: tab-bollinger-refresh
description: >-
  Daily refresh of Bollinger Bands signals via POST
  /bollinger-bands/daily-refresh across 4 methods. Use when refreshing
  Bollinger, '볼린저 밴드 갱신', 'tab-bollinger-refresh'. Do NOT use for Bollinger
  backtesting (use strategy-comparison), Turtle indicators (use
  tab-turtle-refresh), or stock price sync (use tab-stock-sync).
---
