...
description: >-
  ...
  "commit and push", "commit and PR", "push and create PR", "커밋하고 PR", "커밋하고
  푸시", "ship without review", or wants to go from uncommitted changes to an
  open PR without code review. Do NOT use for review-included shipping (use
  ship), full release validation pipeline (use release-commander),
