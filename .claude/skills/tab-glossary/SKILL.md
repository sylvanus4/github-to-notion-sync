...
name: tab-glossary
description: >-
  Manage financial glossary terms via CRUD at /glossary, batch import with
  POST /glossary/batch, search with GET /glossary/search, and export with GET
  /glossary/export. Use when managing glossary, '용어 관리', 'tab-glossary',
  'glossary import export'. Do NOT use for general documentation (use
  technical-writer), news analysis (use tab-news-fetch), or stock data (use
  tab-stock-sync).
---
