...
description: >-
  ...
  codebase search before implementation. Use when starting a new feature,
  adding a dependency, or solving a problem that likely has existing
  solutions. Do NOT use for known implementations. Do NOT use for general web
  search (use WebSearch directly). Korean triggers: "검색 우선", "기존 도구 탐색".
