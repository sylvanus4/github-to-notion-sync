...
description: >-
  ...
  proficiency with badges, drills weak areas, and updates a learning
  dashboard. Use when the user wants to "quiz me", "test my knowledge", "study
  the docs", "docs-tutor", "학습", "퀴즈", "평가", or review specific platform
  topics. Do NOT use for generating the StudyVault (use docs-tutor-setup) or
  for general documentation reading.
---
