...
description: >-
  ...
  content. Use when reviewing content for brand consistency, documenting a
  brand voice, adapting tone for different audiences, or checking terminology
  and style guide compliance. Do NOT use for tasks outside the marketing
  domain. Korean triggers: "리뷰", "체크", "시장", "문서".
---
