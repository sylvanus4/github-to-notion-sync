...
description: >-
  ...
  nature, character, fashion, comedy, animation, fantasy-surreal,
  sports-action, narrative, and more. Outputs prompts ready for
  pika-text-to-video, muapi-cinema, pixelle-generate, or any T2V model.
