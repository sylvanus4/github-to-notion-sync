...
name: x-to-notion
description: >-
  Fetch an X (Twitter) post or article, parse content into structured
  Markdown, translate to Korean, and publish to Notion. Designed for long-form
  X Articles but also handles regular tweets.
---
...
This ensures the URL is registered for cross-repo dedup.
