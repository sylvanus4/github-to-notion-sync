...
description: >-
  ...
  unnecessary complexity. Do NOT use for AI-slop-specific deletion-first
  cleanup (use omc-ai-slop-cleaner). Do NOT use for multi-domain parallel
  review (use deep-review).
---
