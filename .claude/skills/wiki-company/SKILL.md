...
description: >-
  ...
  requirements and trust-level standards defined in _wiki-registry.json. Use
  when the user asks to "add to company wiki", "compile company wiki", "lint
  company wiki", "company knowledge base", "official wiki update", "회사 위키",
  "공식 위키", "회사 지식 추가", "회사 위키 빌드", "company wiki status", "wiki-company", or
  any CRUD operation targeting organization-wide official knowledge topics. Do
  NOT use for team/domain-specific wiki operations (use wiki-team). Do NOT use
  for promoting team content to company (use wiki-promote). Do NOT use for
  personal memory operations (use memkraft skills). Do NOT use for individual
  kb-* operations without company-tier context (invoke kb-ingest, kb-compile,
  kb-lint directly). Korean triggers: "회사 위키", "공식 지식", "회사 위키 빌드", "회사 위키
  린트", "공식 문서 추가".
---
