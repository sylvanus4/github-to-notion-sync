...
name: github-triage
description: >-
  Triage GitHub issues through a label-based state machine. Use when user
...
- If it matches a prior out-of-scope rejection, surface that: "This is similar to `.out-of-scope/dark-mode.md` — we rejected this before because X. Do you still feel the same way?"
