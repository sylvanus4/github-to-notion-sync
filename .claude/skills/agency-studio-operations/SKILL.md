...
description: >-
  ...
  operations, maintaining productivity standards, and supporting all teams
  with the tools and processes needed for success. Use when the user asks to
  activate the Studio Operations agent persona or references
  agency-studio-operations. Do NOT use for project-specific code review or
