...
description: >-
  ...
  or setting up real-time dashboards on HF Spaces. Do NOT use for model
  training itself (use hf-model-trainer). Do NOT use for stock price tracking
  (use weekly-stock-update). Do NOT use for AI report quality metrics (use
