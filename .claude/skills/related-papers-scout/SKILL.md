...
description: >-
  ...
  Semantic Scholar, arXiv, Papers With Code, and Twitter; ranks by
  institution, citations, GitHub stars, and community buzz; posts structured
  Slack thread. Use when the user asks to "find related papers", "similar
  papers", "hot papers", "관련 논문", "유사 논문", "핫한 논문", "논문 추천", "scout papers",
  "related work", "/related-papers-scout". Do NOT use for paper review (use
  paper-review), arXiv-to-slides (use nlm-arxiv-slides), or general web search
  (use parallel-web-search).
---
