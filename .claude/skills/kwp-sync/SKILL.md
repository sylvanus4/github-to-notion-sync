...
description: >-
  ...
  "refresh KWP", "add a new KWP plugin", or "check for upstream KWP changes".
  Do NOT use for optimizing existing skills (use skill-optimizer) or creating
  new skills from scratch (use skill-creator). Korean triggers: "동기화", "최적화",
  "체크", "스킬".
---
