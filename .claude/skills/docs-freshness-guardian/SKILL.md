...
description: >-
  Scheduled scan of docs/ and Notion KB for stale documents (>90 days),
  reminds owners, auto-generates runbook templates from recent postmortems,
  detects undocumented verbal decisions. Use when "docs freshness", "문서 최신성",
  "stale doc check", "runbook generation". Do NOT use for writing new docs
  (use technical-writer), code review (use deep-review). Korean triggers: "문서
  최신성", "문서 프레시니스", "스테일 문서 체크".
---
