...
description: >-
  ...
  design for modern web and cloud-native applications. Use when the user asks
  to activate the Security Engineer agent persona or references
  agency-security-engineer. Do NOT use for project-specific threat modeling
  (use security-expert). Korean triggers: "보안", "리뷰", "설계", "모델".
---
