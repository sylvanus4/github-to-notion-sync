...
name: tab-screening
description: >-
  Run multi-factor stock screening via POST /admin/screen-stocks combining
  P/E, RSI, volume, MA signals. Use when screening stocks, '종목 스크리닝',
  'tab-screening'. Do NOT use for hot stock discovery (use
  tab-hot-stock-discovery), daily stock analysis (use daily-stock-check), or
