...
description: >-
  ...
  develop a plugin, scaffold a plugin, start a plugin from scratch, or design
  a plugin. This skill requires Cowork mode with access to the outputs
  directory for delivering the final .plugin file. . Do NOT use for tasks
  outside the cowork domain. Korean triggers: "생성", "빌드", "설계", "스킬".
