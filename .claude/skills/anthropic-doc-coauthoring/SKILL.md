...
description: >-
  ...
  refine content through iteration, and verify the doc works for readers. Do
  NOT use for Word document generation (use anthropic-docx) or PR/release
  notes (use pr-review-captain). Korean triggers: "문서 공동 작성", "스펙 작성".
---
