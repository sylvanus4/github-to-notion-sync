---
name: goose-onboarding-email-optimizer
description: >-
  Audit and optimize SaaS onboarding email sequences to reduce time-to-value
  and improve activation rates. Analyzes existing sequences against best
  practices, identifies drop-off points, and recommends specific improvements.
