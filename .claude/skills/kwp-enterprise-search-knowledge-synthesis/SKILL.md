...
description: >-
  ...
  freshness and authority, and summarizes large result sets effectively. Do
  NOT use for tasks outside the enterprise domain. Korean triggers: "검색".
---
...
Google Drive result: "API Design Doc v3 — updated section 2 to reflect REST decision"
Linear result: "Task: Finalize API approach — marked complete by Sarah"
```
...
been updated to reflect the decision. The related Linear task is marked complete.

Sources:
- Slack: #engineering thread (Jan 14)
- Gmail: "API Decision" from Sarah (Jan 15)
- Google Drive: "API Design Doc v3" (updated Jan 15)
- Linear: "Finalize API approach" (completed Jan 15)
```
...
The design doc was updated to reflect this (Google Drive: "API Design Doc v3").
```
...
- Google Drive: "API Design Doc v3" last modified Jan 15 — updated specification
```

### Attribution Rules

- Always name the source type (Slack, Gmail, Google Drive, etc.)
...
**Do not:**
- List results source by source ("From Slack: ... From Gmail: ... From Google Drive: ...")
