---
name: goose-ad-landing-page-auditor
description: >-
  Audit the message match between ad copy and landing pages. Checks for
  headline consistency, CTA alignment, promise fulfillment, trust signals, and
  conversion friction. Produces a scorecard with specific fix recommendations
  for improving ad-to-page conversion rates.
---
