...
description: >-
  ...
  real assets, exact design tokens, and interaction behaviors. Use when the
  user asks to "clone a website", "replicate a site", "rebuild this page",
  "reverse-engineer this website", "pixel-perfect copy", "make a copy of this
  site", "copy this website", "website cloner", "clone-website", or provides a
  URL with intent to recreate the site. Do NOT use for general web scraping
  without rebuild intent (use scrapling or defuddle). Do NOT use for
  screenshot-only capture (use agent-browser). Do NOT use for design token
  extraction without full rebuild (use figma-dev-pipeline). Do NOT use for
  testing existing web apps (use e2e-testing or qa-dogfood).
