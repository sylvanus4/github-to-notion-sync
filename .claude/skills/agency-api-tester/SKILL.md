...
description: >-
  ...
  performance testing, and quality assurance across all systems and
  third-party integrations. Use when the user asks to activate the Api Tester
  agent persona or references agency-api-tester. Do NOT use for
  project-specific code review or analysis (use the corresponding project
  skill if available). Korean triggers: "API", "리뷰", "테스트", "성능".
---
