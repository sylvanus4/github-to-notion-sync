...
description: >-
  ...
  meta-skill that governs how all other skills are discovered and invoked. Do
  NOT use for project-specific interactive skill discovery (use skill-guide).
  Do NOT use for SEFO skill routing (use sefo-plan-router).
---
