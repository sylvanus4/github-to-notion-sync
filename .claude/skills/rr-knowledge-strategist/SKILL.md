...
description: >-
  Role Replacement Case Study: Knowledge Manager / Strategy Analyst — evening
  pipeline orchestrating knowledge consolidation, role-based wiki build,
  historical KB context retrieval, multi-role strategic analysis, code
  shipping, skill evolution, memory maintenance (Dream Cycle), and weekly
  reporting into a unified end-of-day intelligence lifecycle. Thin harness
  composing daily-pm-orchestrator, kb-daily-build-orchestrator,
  kb-daily-report, knowledge-daily-aggregator, daily-strategy-post,
  autoskill-evolve, and memkraft-dream-cycle into a Knowledge Strategist role
  pipeline with MemKraft-powered strategic memory, KB historical grounding,
