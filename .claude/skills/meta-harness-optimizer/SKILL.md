---
name: meta-harness-optimizer
description: >-
  Outer-loop optimization skill that iteratively improves a target skill (or
  skill chain) by treating it as a "harness" — the stateful code wrapping a
  fixed LLM. Adapts Algorithm 1 from the Meta-Harness paper (arXiv:2603.28052)
  using filesystem-based uncompressed execution traces, an agentic coding pr
---
