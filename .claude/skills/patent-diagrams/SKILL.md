...
description: >-
  ...
  diagram". Do NOT use for prior art search (use patent-search). Do NOT use
  for claim drafting (use patent-us-drafting or patent-kr-drafting). Do NOT
  use for general architecture diagrams without patent context (use
  visual-explainer). Korean triggers: "특허 도면", "도면 생성", "블록도", "순서도", "특허 그림".
---
