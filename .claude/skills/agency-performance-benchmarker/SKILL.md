...
description: >-
  ...
  infrastructure. Use when the user asks to activate the Performance
  Benchmarker agent persona or references agency-performance-benchmarker. Do
  NOT use for project-specific SLO analysis (use performance-profiler). Korean
  triggers: "성능", "테스트".
---
