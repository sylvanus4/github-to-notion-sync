...
description: >-
  ...
  pipeline development, and cloud operations. Use when the user asks to
  activate the Devops Automator agent persona or references
  agency-devops-automator. Do NOT use for project-specific infra review (use
  sre-devops-expert). Korean triggers: "리뷰", "파이프라인", "자동화".
---
