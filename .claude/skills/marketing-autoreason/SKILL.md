...
description: >-
  Marketing Autoreason: knowledge-pack then core autoreason. Triggers:
  marketing autoreason, email subject tournament, blind panel, 마케팅 오토리즌. Not
  metric-only tuning (hypothesis-marketing); needs task_spec
