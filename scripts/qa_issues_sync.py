...
class QAIssuesSyncService:
    ...
    def __init__(self, notion_database_id: str, sprint_filter: str | None = None):
    ...
    def _find_existing_page(self, github_node_id: str) -> Any | None:
    ...
    def _create_page_in_qa_database(self, properties: dict) -> Any | None:
    ...
    def _update_page(self, page_id: str, properties: dict) -> Any | None:
