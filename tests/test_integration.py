...
from src.models.webhook_models import WebhookEventType, WebhookParser
...
class TestEnvironmentSetup:
    ...
    def test_environment_variables(self):
        ...
        required_vars = ["GH_TOKEN", "NOTION_TOKEN", "GH_ORG", "GH_PROJECT_NUMBER", "NOTION_DB_ID", "GH_WEBHOOK_SECRET"]
...
class TestWebhookHandler:
    ...
    async def test_webhook_parsing(self, webhook_handler):
        ...
        webhook_event = WebhookParser.create_webhook_event(
            "projects_v2_item", "test-delivery-id", "test-signature", sample_payload
        )
...
def run_integration_tests():
    ...
    try:
        ...
        exit_code = pytest.main([__file__, "-v", "--tb=short", "-s"])  # Don't capture output
