...
Read and follow the `knowledge-daily-aggregator` skill (`.cursor/skills/knowledge-daily-aggregator/SKILL.md`).
...
Read and follow the `daily-strategy-post` skill (`.cursor/skills/daily-strategy-post/SKILL.md`).
...
Read and follow the `eod-ship` skill (`.cursor/skills/eod-ship/SKILL.md`).
...
Read and follow `autoskill-evolve` skill (`.cursor/skills/autoskill-evolve/SKILL.md`).
...
Read and follow `skill-guide-generator` skill (`.cursor/skills/skill-guide-generator/SKILL.md`).
...
Read and follow `weekly-status-report` skill (`.cursor/skills/weekly-status-report/SKILL.md`).
...
Read and follow `portfolio-report-generator` skill (`.cursor/skills/portfolio-report-generator/SKILL.md`).
