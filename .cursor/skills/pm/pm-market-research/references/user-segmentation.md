...
### Input
Your task is to segment users for **{product}** based on behavior, jobs-to-be-done, and unmet needs.
...
- How this segment uses {product} (primary use cases, frequency, depth)
...
**Current Product Fit**
- How well {product} currently serves this segment
