...
description: >-
  Manages deprecation and migration. Use when removing old systems, APIs, or features. Use when migrating users from one implementation to another. Use when deciding whether to maintain or sunset existing code. Do NOT use for dependency CVE scanning (use dependency-auditor). Do NOT use for API versioning review (use backend-expert).
metadata:
  author: "addyosmani"
  version: "1.0.0"
  category: "addyosmani"
