...
description: >-
  Builds production-quality UIs. Use when building or modifying user-facing interfaces. Use when creating components, implementing layouts, managing state, or when the output needs to look and feel production-quality rather than AI-generated. Do NOT use for project-specific React/Vite review (use frontend-expert). Do NOT use for TDS component usage (follow 03-tds-essentials.mdc).
metadata:
  author: "addyosmani"
  version: "1.0.0"
  category: "addyosmani"
