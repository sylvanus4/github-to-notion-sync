...
You are creating a competitive battlecard for the user-provided competitor or product context. Use web search to research the competitor's current product, pricing, positioning, and recent changes. If the user provides files (feature lists, win/loss data, sales call notes), read them first.
