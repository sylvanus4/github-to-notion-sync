...
- Answer length must match question complexity — do not pad simple yes/no questions with unnecessary detail
...
- Evidence links must point to specific document sections, not entire documents
