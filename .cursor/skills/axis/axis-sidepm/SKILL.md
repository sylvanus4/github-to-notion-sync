...
description: >-
  ...
  multi-project registry, sprint orchestration, code shipping, CI/CD,
  and PR management across 5 ThakiCloud repositories. Use when the user
  asks for "axis sidepm", "side project axis", "사이드PM 축", "project axis",
  ...
  Do NOT use for daily git sync only (use sod-ship or eod-ship).
metadata:
  author: thaki
  version: "1.0.0"
