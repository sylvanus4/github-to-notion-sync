---
description: "Query event-study pattern groups via GET /patterns, search with GET /patterns/search, get statistics with GET /patterns/stats, and export with GET /patterns/export. Use when querying patterns, '패턴 조회', 'tab-patterns', 'pattern analysis'. Do NOT use for event detection (use tab-event-detect), event study CAR analysis (use tab-analysis-run), or stock price sync (use tab-stock-sync)."
---
