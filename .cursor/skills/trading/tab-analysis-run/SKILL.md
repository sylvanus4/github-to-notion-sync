---
description: "Run event study analysis (CAR), generate reports, and query patterns. Use when running analysis, '분석 실행', 'tab-analysis-run', 'event study', 'generate daily report'. Do NOT use for event detection (use tab-event-detect), stock screening (use tab-screening), or technical analysis (use tab-technical-analysis)."
---
