...
description: >-
  ...
  "토스증권 설치", "토스 로그인", "토스 설정", or needs to configure tossctl
  for the first time.
  Do NOT use for read-only account/portfolio queries (use tossinvest-cli).
  Do NOT use for live trading operations (use tossinvest-trading).
  Do NOT use for general brokerage setup unrelated to Toss Securities.
triggers:
  - install tossctl
  - tossinvest setup
  - toss login
  ...
  - tossctl 설치
  - tossctl 설정
tags: [trading, brokerage, setup, toss-securities, korean-market]
metadata:
  author: "thaki"
  version: "1.0.0"
  category: "setup"
