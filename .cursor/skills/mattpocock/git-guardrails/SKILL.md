...
name: git-guardrails
description: >
  Set up hooks to block dangerous git commands (push, reset --hard, clean, branch -D, etc.)
  before they execute. Use when user wants to "add git safety", "block force push",
  "git guardrails", or protect against destructive git operations.
---
