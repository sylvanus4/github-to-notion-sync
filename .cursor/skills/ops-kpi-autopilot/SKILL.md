---
description: Scheduled ops KPI dashboard from Notion + monitoring data. Use when "ops KPI", "운영 KPI", "ops dashboard". Do NOT use for business sales metrics (use sales-weekly-dashboard).
---
# ops-kpi-autopilot
