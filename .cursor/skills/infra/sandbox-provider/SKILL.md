...
description: Manage sandbox execution environments for agent workloads — provision E2B/Modal/Docker sessions, execute code in isolation, and integrate with the ATG sandbox endpoint.
version: 1.1.0
tags: [sandbox, e2b, modal, isolation, agent-compute, infrastructure]
triggers:
  - sandbox provider
  - create sandbox
  - e2b sandbox
