...
|---|-------|-----------------|
| 1 | `role-ceo` | "Read .cursor/skills/role-ceo/SKILL.md. Analyze this topic from CEO perspective: {topic}. {scope}. Follow the skill instructions. Output structured Korean markdown. Start with relevance scoring. If score < 5, return only: '## 관련도: {N}/10\n관련 없음 — {brief reason}'" |
...
```
Read .cursor/skills/executive-briefing/SKILL.md and follow its instructions.
