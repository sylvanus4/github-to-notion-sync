...
version: 1.0.0
description: "Dedicated skill for resolving build/compile errors across Python, Node.js, and Go — runs build, parses errors, classifies, fixes in priority order, and re-runs until clean."
---
