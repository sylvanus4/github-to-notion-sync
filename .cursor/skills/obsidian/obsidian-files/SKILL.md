...
description: >-
  ...
  bookmarks, or perform any file operation in Obsidian. Do NOT use for
  daily notes (use obsidian-daily), search (use obsidian-search), tags or
  tasks (use obsidian-notes), plugin management (use obsidian-admin), or
  developer tools (use obsidian-dev).
  Korean triggers: "옵시디언 파일", "노트 생성", "노트 읽기", "볼트 관리",
