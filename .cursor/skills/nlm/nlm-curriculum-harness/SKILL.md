...
description: >-
  ...
  dispatching research-scout, architect, content-gen, material-prod, quality-eval,
  and updater agents in configurable pipeline/fan-out patterns.
  Use when the user asks to "build curriculum harness", "curriculum meta-harness",
  "tech-update curriculum", "benchmark curriculum", "rapid bootcamp",
  "multi-tech fusion curriculum", "커리큘럼 하네스", "메타 하네스 커리큘럼",
  "커리큘럼 업데이트", "커리큘럼 벤치마크", "급속 부트캠프 커리큘럼",
  "nlm-curriculum-harness", or any request to build/update/compare curricula using
  the multi-agent harness architecture.
  Do NOT use for simple single-pass curriculum builds -- use nlm-curriculum-builder.
  Do NOT use for personal accelerated learning -- use nlm-deep-learn.
  Do NOT use for ad-hoc NLM studio operations -- use notebooklm-studio.
  Do NOT use for slide-only generation -- use nlm-slides.
metadata:
  author: thaki
  version: 1.0.0
