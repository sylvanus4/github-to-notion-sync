...
description: >-
  Master orchestrator for Vibe-Trading integration -- composes vibe-trading-data,
  vibe-trading-backtest, vibe-trading-swarm, and vibe-trading-quant into 4
  workflow modes: Discovery, Research, Cross-Validation, and Strategy.
  Use when the user asks to "vibe-trading analysis", "full vibe pipeline",
  "vibe-trading orchestrator", "vibe research workflow", "vibe strategy pipeline",
  "바이브 오케스트레이터", "바이브 종합 분석", "바이브 파이프라인",
  or wants an end-to-end finance analysis through Vibe-Trading.
  Do NOT use for individual Vibe-Trading operations (invoke the specific skill).
  Do NOT use for the project's daily pipeline (use today).
  Do NOT use for setup (use vibe-trading-setup).
tags: [vibe-trading, orchestrator, workflow, pipeline]
version: 1.0.0
---
