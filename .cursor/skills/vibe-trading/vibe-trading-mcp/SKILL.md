...
description: >-
  ...
  does vibe-trading have", "바이브 트레이딩 MCP 도구", "바이브 MCP 참조",
  or needs to understand which MCP tool to call for a specific finance task.
  Do NOT use for setup/installation (use vibe-trading-setup).
  Do NOT use for orchestrated workflows (use vibe-trading-orchestrator).
tags: [vibe-trading, mcp, reference, tools]
version: 1.0.0
---
