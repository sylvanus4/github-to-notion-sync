...
description: >-
  ...
  "decompose to fundamentals", "기본 원리 분석", "가정 제거", "근본 분석",
  "본질 분석", "제1원리", or any request to analyze a topic by removing
  inherited thinking. Do NOT use for code review (use deep-review), problem
  definition with root cause analysis (use problem-definition), prompt
  optimization (use prompt-architect), or financial fundamental analysis
  like P/E ratios (use trading-us-stock-analysis).
metadata:
  author: "thaki"
  version: "1.0.0"
  category: "analysis"
