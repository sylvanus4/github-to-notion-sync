...
version: 1.0.0
description: Run SEFO skill retrieval and DAG composition for plan-aware skill routing. Discovers the best skills for a task and generates execution phases with dependency ordering.
triggers:
  - sefo plan
  - sefo route
  - skill routing
