...
description: >-
  ...
  "IA score", "session evaluation", "skill performance", "의도 정렬 점수",
  "세션 평가", "스킬 성능 추적", or wants post-session evaluation and trend
  dashboards. Do NOT use for AI report quality (use ai-quality-evaluator),
  code review (use deep-review), or general LLM evaluation (use evals-skills).
metadata:
  author: thaki
  version: "0.1.0"
