...
description: >-
  ...
  .stitch/next-prompt.md. Enables continuous website development via
  Stitch MCP with design system consistency.
metadata:
  author: thaki
  version: "1.0.0"
  category: frontend
  origin: google-labs-code/stitch-skills/stitch-loop
---
