...
description: >-
  ...
  components — discovery, installation, customization, and best practices
  with Radix UI or Base UI primitives and Tailwind CSS.
metadata:
  author: thaki
  version: "1.0.0"
  category: frontend
  origin: google-labs-code/stitch-skills/shadcn-ui
---
