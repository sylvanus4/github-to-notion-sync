...
description: >-
  Detect and reject generic, template-looking, or design-system-violating
  UI code. Scans TSX/CSS for 35+ anti-patterns defined by the Refined Swiss
  design system and produces a severity-ranked violation report with auto-fix.
metadata:
  author: thaki
  version: "1.1.0"
  category: frontend
  origin: google-labs-code/stitch-skills (taste-design)
---
