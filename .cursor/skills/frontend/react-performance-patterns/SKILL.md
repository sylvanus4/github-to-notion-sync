...
description: >
  ...
  stacks.  Covers waterfalls, bundle size, data fetching, re-renders, rendering,
  JS micro-optimizations, and advanced patterns.  Self-contained — no external
  URL fetching required.
triggers:
  - react performance
  - optimize react
  - eliminate waterfall
...
boundaries:
  ...
  - Do NOT use for UX heuristic evaluation (use ux-expert)
  - Do NOT use for final visual polish pass (use polish)
  - Do NOT use for component composition architecture (use react-composition-guide)
---
