...
name: stitch-design
description: >-
  Unified entry point for Google Stitch design work. Handles prompt enhancement,
  design system synthesis (.stitch/DESIGN.md), and high-fidelity screen
  generation/editing via Stitch MCP server.
metadata:
  author: thaki
  version: "1.0.0"
  category: frontend
  origin: google-labs-code/stitch-skills/stitch-design
---
