...
description: >-
  Analyze the project's frontend codebase and design-system.mdc to generate
  a structured DESIGN.md in the awesome-design-md format, optimized for
  AI-agent UI generators like Google Stitch and Cursor.
metadata:
  author: thaki
  version: "1.1.0"
  category: frontend
  origin: google-labs-code/stitch-skills (design-md)
---
