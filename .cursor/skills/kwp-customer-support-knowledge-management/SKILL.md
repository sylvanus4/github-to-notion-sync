...
description: >-
  ...
  updating existing KB articles, or when creating how-to guides, troubleshooting
  docs, or FAQ entries. Do NOT use for tasks outside the customer domain. Korean
  triggers: "문서".
metadata:
