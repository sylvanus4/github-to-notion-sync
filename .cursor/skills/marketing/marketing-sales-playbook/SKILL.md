...
version: 1.0.0
description: Value-based pricing framework — pre-call briefings with competitive intelligence, tier-based pricing package design, sales call scoring, and pattern library for pricing strategy evolution.
---
