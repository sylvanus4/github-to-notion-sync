...
version: 1.0.0
description: Podcast-to-everything content pipeline — transforms a single episode into 20+ content pieces across LinkedIn, Twitter, newsletters, blog posts, YouTube Shorts scripts, with viral scoring and deduplication.
---
