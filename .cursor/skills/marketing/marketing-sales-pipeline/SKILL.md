...
version: 1.0.0
description: Visitor-to-pipeline automation combining RB2B visitor identification, intent-based routing, deal resurrection, trigger prospecting, ICP learning, and suppression management.
---
