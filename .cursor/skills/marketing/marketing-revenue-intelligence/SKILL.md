...
version: 1.0.0
description: Revenue intelligence combining Gong call insights, multi-touch content-to-revenue attribution, and automated client report generation with GA4, HubSpot, and Ahrefs integration.
---
