...
version: 1.0.0
description: Marketing team operations — Elon Algorithm 5-step performance audit with stack ranking, and meeting intelligence that extracts actions, decisions, and commitments from transcripts.
---
