...
version: 1.0.0
description: Autonomous marketing experiment lifecycle — create, run, measure, optimize growth experiments using Karpathy-style auto-experimentation with statistical scoring, pacing alerts, and weekly scorecards.
---
