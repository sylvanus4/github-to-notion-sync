---
description: Monitor Notion pipeline DB for stage changes, enforce checklist completion, auto-generate handoff docs, notify teams, track SLA. Use when "deal stage", "stage transition", "딜 스테이지", "핸드오프". Do NOT use for single deal analysis (use kwp-sales-account-research).
---
