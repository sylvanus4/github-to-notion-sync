...
version: 1.0.0
description: >
  End-to-end meeting intelligence pipeline that ingests transcripts, extracts decisions
  and action items with structured tracking, logs decisions to a persistent decision
  register, creates calendar follow-ups, analyzes trends across meeting series, and
  delivers structured Korean summaries to Notion and Slack. Extends meeting-digest with
  CRM-style decision tracking, action item lifecycle, and multi-meeting trend analysis.
  Use when the user asks to "analyze meeting and track decisions", "meeting intelligence",
  "meeting-intelligence-system", "회의 인텔리전스", "회의 분석 + 의사결정 추적",
  "회의 트렌드 분석", "액션 아이템 추적 포함 회의 분석", "multi-meeting analysis",
  "meeting series trends", or wants a meeting summary with decision logging, action
  tracking, and calendar integration. Do NOT use for simple meeting summary without
  tracking (use meeting-digest). Do NOT use for action item tracking without meeting
  context (use meeting-action-tracker). Do NOT use for decision logging without meeting
  context (use decision-tracker).
tags: [meeting, intelligence, decisions, action-items, trends, monetizable]
triggers:
  - "meeting intelligence"
  - "meeting intelligence system"
  - "meeting-intelligence-system"
  - "analyze meeting and track"
  - "meeting with decision tracking"
  ...
  - "의사결정 추적 회의"
do_not_use:
  - "For simple meeting summary without tracking (use meeting-digest)"
  - "For action item tracking without meeting context (use meeting-action-tracker)"
  - "For decision logging without meeting context (use decision-tracker)"
  - "For scheduling meetings (use smart-meeting-scheduler)"
  - "For batch Notion meeting sync (use notion-meeting-sync)"
composes:
  - meeting-digest
  - md-to-notion
  - decision-tracker
