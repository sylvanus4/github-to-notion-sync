...
description: >-
  Headcount planning, org design, and team structure optimization. Trigger with
  "org planning", "headcount plan", "team structure", "reorg", "who should we
  hire next", or when the user is thinking about team size, reporting structure,
  or organizational design. Do NOT use for tasks outside the human domain.
  Korean triggers: "설계", "계획", "리포트".
metadata:
