...
description: >-
  Create element-by-element claim charts mapping patent claims against prior art
  references or accused products. Supports both US-style (broad functional
  ...
  "infringement analysis", "element-by-element comparison", "invalidity chart",
  or "claim charting". Do NOT use for prior art searching (use patent-search).
  Do NOT use for drafting claims (use patent-us-drafting or patent-kr-drafting).
  Do NOT use for responding to office actions (use patent-us-oa-response or
  patent-kr-oa-response). Korean triggers: "클레임 차트", "청구항 비교",
  "요소별 대비", "침해 분석", "무효 차트".
metadata:
  version: "1.0.0"
  category: "analysis"
