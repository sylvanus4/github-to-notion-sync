...
description: >-
  ...
  jurisdiction or task type, e.g. "patent this idea", "특허 도와줘", "help
  with patent", "analyze this for patentability", "patent workflow", "특허
  출원 절차", or any broad patent request. Do NOT use when the user already
  specifies a jurisdiction and task (route to the specific skill directly).
  Korean triggers: "특허", "특허 도와줘", "특허 출원", "발명 보호", "patent".
metadata:
  version: "1.0.0"
