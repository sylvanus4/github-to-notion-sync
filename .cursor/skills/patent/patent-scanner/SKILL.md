...
description: >-
  ...
  drafting patent claims (use patent-us-drafting or patent-kr-drafting). Do NOT
  use for reviewing existing patent applications (use patent-us-review or
  patent-kr-review). Korean triggers: "특허 가능한 아이디어", "발명 발굴",
  "특허 스캔", "발명 식별", "혁신 감사".
metadata:
  version: "1.0.0"
  category: "analysis"
