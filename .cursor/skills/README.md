...
| [notion-docs-sync](notion/notion-docs-sync/SKILL.md)               | Notion, 문서 동기화           | Markdown 문서를 Notion에 동기화                  |
...
node .cursor/skills/notion/notion-docs-sync/scripts/sync.mjs .cursor/skills/docs/.notion-sync.yaml
```
