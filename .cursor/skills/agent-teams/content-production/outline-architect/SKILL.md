...
description: >
  ...
  outlines with hooks, section flow, key arguments, and CTAs based on
  research data. Invoked only by content-production-coordinator.
metadata:
  tags: [content, outline, structure, multi-agent]
  compute: local
---
