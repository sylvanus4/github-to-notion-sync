...
description: >
  Expert agent for the Content Production Team. Researches the target topic
  to gather audience insights, trending angles, competitive content gaps,
  and supporting data before content creation begins.
  Invoked only by content-production-coordinator.
metadata:
  tags: [content, research, multi-agent]
  compute: local
---
