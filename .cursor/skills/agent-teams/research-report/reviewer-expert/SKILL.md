...
description: >
  ...
  6 quality dimensions, scores each dimension, identifies specific issues,
  and produces structured feedback for the coordinator's quality gate.
  Invoked only by research-report-coordinator.
metadata:
  tags: [review, quality-gate, multi-agent]
  compute: local
---
