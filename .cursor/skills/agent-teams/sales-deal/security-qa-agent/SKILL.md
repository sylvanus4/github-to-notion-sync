...
description: >
  Expert agent for the Sales Deal Team. Prepares security, sovereignty,
  and compliance Q&A responses tailored to the customer's segment and
  the proposal's architecture choices.
  Invoked only by sales-deal-coordinator.
metadata:
  tags: [sales, security, compliance, qa, multi-agent]
  compute: local
---
