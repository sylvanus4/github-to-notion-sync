...
description: >
  Expert agent for the Incident Response Team. Drafts professional,
  empathetic customer-facing incident communications tailored to severity
  level and audience. Separates customer-safe information from internal-only
  details. Produces initial notification, progress update, and resolution
  notification templates.
  Invoked only by incident-response-coordinator for SEV1/SEV2 incidents.
metadata:
  tags: [incident, communication, customer, multi-agent]
  compute: local
---
