...
description: >
  Expert agent for the Meeting Intelligence Team. Extracts formal and
  informal decisions from the transcript analysis, classifies them by
  type and impact, identifies decision owners, and flags decisions
  requiring follow-up or escalation.
  Invoked only by meeting-intel-coordinator.
metadata:
  tags: [meeting, decision, extraction, multi-agent]
  compute: local
---
