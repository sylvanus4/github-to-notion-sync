...
description: >
  ...
  extracted decisions, and action items. Produces a structured Korean
  summary suitable for Notion publishing and Slack distribution.
  Invoked only by meeting-intel-coordinator.
metadata:
  tags: [meeting, summary, writing, multi-agent]
  compute: local
---
