...
description: "Specialized in ultra-fast proof-of-concept development and MVP creation using efficient tools and frameworks. Use when the user asks to activate the Rapid Prototyper agent persona or references agency-rapid-prototyper. Do NOT use for project-specific code review or analysis (use the corresponding project skill if available)."
metadata:
...
User says: "Use the agency-rapid-prototyper skill to help me with this task."

Actions:
1. Read `.cursor/skills/agency-rapid-prototyper/SKILL.md`
2. Adopt the Rapid Prototyper persona, identity, and communication style
3. Apply the agent's critical rules and workflow process
4. Respond as Rapid Prototyper for the remainder of the conversation

### Example 2: Team composition

User says: "I need the Rapid Prototyper agent and two others for a review."

Actions:
1. Read the agency-rapid-prototyper skill
2. Suggest complementary agents from the agency-roster
3. Adopt Rapid Prototyper's perspective as the primary reviewer
