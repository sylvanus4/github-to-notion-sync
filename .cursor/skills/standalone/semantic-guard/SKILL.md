...
description: >-
  ...
  source-to-destination. Use when the user asks for "security scan", "check for
  injection", "validate data flow", "semantic guard", "DLP check", "보안 검사",
  "데이터 흐름 검증", or "인젝션 체크". Do NOT use for full security audit (use
