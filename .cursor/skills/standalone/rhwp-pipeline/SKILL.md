...
description: >-
  ...
  workflow", "HWPX 생성", "공문서 작성", "한글 공문서", "HWPX 네이티브",
...
Generate HWPX documents programmatically without a pre-existing HWP template.
Uses the `python-hwpx` library (OWPML standard) for native HWPX authoring.
