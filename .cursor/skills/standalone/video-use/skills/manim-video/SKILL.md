---
name: manim-video
description: "Production pipeline for mathematical and technical animations using Manim Community Edition. Creates 3Blue1Brown-style explainer videos, algorithm visualizations, equation derivations, architecture diagrams, and data stories. Use when the user asks to 'create Manim animation', 'math animation', 'algorithm visualization', 'equation animation', '3Blue1Brown style', 'animated explainer', 'concept visualization', 'data story animation', 'architecture animation', 'paper explainer animation', '3D math visualization', 'Manim render', '수학 애니메이션', '알고리즘 시각화', '수식 애니메이션', '개념 시각화', '데이터 스토리 애니메이션', '아키텍처 애니메이션', '논문 설명 애니메이션', '3D 수학 시각화', 'Manim 렌더', or any request for programmatic mathematical/technical animation overlays. Do NOT use for general video editing without animation (use video-use parent skill). Do NOT use for AI video generation from text prompts (use pika-text-to-video). Do NOT use for Remotion motion graphics without Manim (use remotion-motion-forge). Do NOT use for static diagrams or architecture charts (use architecture-diagram or visual-explainer). Do NOT use for p5.js generative art (use anthropic-algorithmic-art)."
version: 1.1.0
---
