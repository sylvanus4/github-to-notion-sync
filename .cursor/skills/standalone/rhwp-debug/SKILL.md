...
description: >-
  ...
  "HWP 렌더링 문제", "HWP 구조 분석", or encounters rendering issues in HWP
  documents. Do NOT use for simple viewing (use rhwp-viewer). Do NOT use for
  format conversion (use rhwp-converter). Do NOT use for installing rhwp (use
  rhwp-setup).
metadata:
  author: "thaki"
  version: "1.0.0"
