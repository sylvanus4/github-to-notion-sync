...
description: >-
  ...
  subtitles", "format SRT", "generate VTT", "make captions", "자막 만들어줘",
  "SRT 파일", "VTT 생성", "자막 포맷", "subtitle formatting",
  "caption-subtitle-formatter", or wants properly formatted subtitle files
  from a transcript. Do NOT use for transcription (use transcribee). Do NOT
  use for social media captions/copy (use marketing-podcast-ops or
  content-repurposing-engine). Do NOT use for YouTube transcript extraction
  (use defuddle). Do NOT use for video script writing (use
