...
name: hookify
version: 1.0.0
description: "Interactive Cursor hook builder — guides through selecting hook event types, defining conditions, writing scripts, registering in hooks.json, and testing."
---
