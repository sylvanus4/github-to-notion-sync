...
version: "1.1"
category: standalone/document-generation
author: ThakiCloud
description: Generate professional-grade tables for Korean elementary school teachers — curriculum progress, lesson plans, rubrics, observation records, research tables, management plans, and timetables. Primary output is DOCX via python-docx; HWP via rhwp-pipeline conversion; PDF via pandoc or rhwp-converter.
triggers:
  - "교육용 표 만들어줘"
  - "초등 지도안 표"
  - "루브릭 표"
