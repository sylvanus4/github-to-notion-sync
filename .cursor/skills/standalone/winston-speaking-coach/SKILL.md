...
description: >-
  Apply Patrick Winston's MIT "How to Speak" framework as a pre-production coach
  for any speaking or presentation content. Covers 7 modules: Empowerment Promise,
  Circle & Star mapping, Near Miss examples, narrative arc building, slide content
  audit, opening/closing scripts, and venue/delivery checklist.
  Use when the user asks to "winston coach", "speaking coach", "how to speak review",
  "presentation coach", "winston framework", "review my talk", "coach my presentation",
  "apply winston", "발표 코칭", "발표 프레임워크", "윈스턴 코치", "발표 리뷰",
  "스피킹 코치", or wants a structured communication review before building slides.
  Do NOT use for rendering slides as .pptx (use anthropic-pptx). Do NOT use for
  presentation content strategy without Winston focus (use presentation-strategist).
  Do NOT use for written-only documents without a speaking component. Do NOT use
  for podcast scripts (different medium). Do NOT use for marketing copy (use
