...
1. [Mermaid.js — Diagramming Engine](#mermaidjs--diagramming-engine)
2. [Chart.js — Data Visualizations](#chartjs--data-visualizations)
3. [anime.js — Orchestrated Animations](#animejs--orchestrated-animations)
4. [Google Fonts — Typography](#google-fonts--typography)
