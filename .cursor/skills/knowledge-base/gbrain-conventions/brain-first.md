...
- The brain has context that external APIs don't (user's direct observations,
  meeting notes, personal relationships)
...
- `ai-context-router` — Layer 0 brain-first gate for entity queries
- `gbrain-ingest` — Step 0 brain-first lookup before entity creation
- `gbrain-briefing` — brain-first context assembly
- `session-preflight` — gbrain health verification at session start
