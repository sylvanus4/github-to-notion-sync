...
## Back-Linking (MANDATORY — Iron Law)
...
- `gbrain-ingest` — citation enforcement in Step 7, back-linking in Step 6
- `gbrain-maintain` — citation and backlink compliance checks in diagnostics
- `ai-context-router` — brain-first protocol ensures brain data is consulted first
