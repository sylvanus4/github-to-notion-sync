...
description: >-
  Nightly MemKraft maintenance: consolidate sessions into topics, decay stale entries,
  resolve orphan entities, promote repeated patterns to preferences, and archive
  COLD-tier entries. Uses existing attention_decay.py and extract-sessions.py.
triggers:
  - dream cycle
  - memkraft dream
  - nightly maintenance
...
do_not_use_for:
  - Querying personal memory (use memkraft)
  - Writing new memories (use memkraft-ingest)
  - LLM Wiki operations (use wiki-company or wiki-team)
  - Manual memory edits (edit files directly)
---
