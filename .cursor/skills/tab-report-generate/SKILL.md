---
description: "Generate a daily Korean .docx stock analysis report via POST /reports/generate/daily and list past reports with GET /reports. Use when generating daily report, '일일 리포트 생성', 'tab-report-generate', 'generate report'. Do NOT use for daily stock signals only (use daily-stock-check), stock price sync (use tab-stock-sync), or news fetch only (use tab-news-fetch)."
---
