...
description: "Break a GDD into sprint-ready development stories with acceptance criteria and dependency ordering. Use when the user asks to 'break down GDD', 'create dev stories', 'game-dev-story', 'sprint plan for game', '게임 스프린트 분해', '개발 스토리 생성', '게임 태스크 분해'. Do NOT use for initial concept design (use game-studio-design-system). Do NOT use for QA planning (use game-studio-qa-plan). Do NOT use for brainstorming (use game-studio-brainstorm)."
---
