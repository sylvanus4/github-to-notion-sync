...
description: >-
  ...
  output, classifies IAM/networking/storage/compute changes, scores risk 1–10,
  ...
  review", "IaC risk review", "plan risk assessment", "테라폼 플랜 리뷰",
  "IaC 검토", "변경 위험 분석", "msp terraform plan", or MSP change-board risk
