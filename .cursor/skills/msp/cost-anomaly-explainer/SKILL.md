...
description: >-
  ...
  changes to billing or infrastructure. Uses AWS Cost Explorer/CUR/Budgets
  and GCP Billing export/BigQuery/Recommender API. Use when the user asks to
  ...
  unrelated to cost (use incident-triage-summarizer). Korean triggers: 비용
  이상, 과금 급증, 비용 스파이크 분석, 클라우드 비용 설명, 청구 이상 분석.
metadata:
  author: "thaki"
  version: "1.0.0"
  category: "msp/finops"
