...
description: >-
  ...
  Transforms ADR-style output into numbered task format, writes to docs/plans/,
  and invokes execution with optional auto-accept and skip-review flags.
triggers:
  - "ralplan execute"
  - "plan and execute"
  ...
  - "ralplan 실행"
do_not_use_for:
  - Planning without execution intent (use omc-ralplan directly)
  - Execution of pre-existing plan files (use sp-executing-plans directly)
