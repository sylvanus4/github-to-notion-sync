...
description: |
  Designs a comprehensive digital-twin style persona from a person's full digital footprint: email, social posts,
  long-form writing, and recorded conversations—with explicit ethics, consent, and data-governance gates. Use for
  digital legacy and continuity planning—not for shallow one-source persona sketches (use nuwa/distill) and not as
  a substitute for bereavement care or clinical mental health support.
---
