...
name: distill
description: |
  Streamlined, single-pass persona distillation workflow: faster than Nuwa, shallower than full triple verification.
  Produces a functional Agent Skill when time or source material is limited. Use for quick persona drafts—not when
  you need forensic multi-source fidelity (use nuwa) or fully automated ingestion (use auto-distill).
---
