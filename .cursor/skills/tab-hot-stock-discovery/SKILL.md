---
description: "Discover hottest untracked stocks from NASDAQ/KOSPI/KOSDAQ 100 via POST /admin/discover-hot-stocks. Use when discovering hot stocks, '핫 종목 발견', 'tab-hot-stock-discovery'. Do NOT use for stock screening (use tab-screening) or stock price sync (use tab-stock-sync)."
---
