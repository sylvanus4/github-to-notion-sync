---
description: "Refresh and query market environment (regime, breadth, news, signals) via POST /market-environment/refresh and GET /market-environment/summary, /details, /history, /regime/timeline. Use when checking market environment, '시장 환경 분석', 'tab-market-environment', 'market environment check'. Do NOT use for market breadth only (use tab-market-breadth), news only (use tab-news-fetch), or stock price sync (use tab-stock-sync)."
---
