...
description: >-
  ...
  from a spreadsheet, import events from sheet data, or batch schedule from
  a table. Do NOT use for single event creation (use gws-calendar) or
  non-calendar data (use gws-sheets).
metadata:
