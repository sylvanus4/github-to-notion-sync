...
def parse_arguments():
    ...
    parser.add_argument(
        ...
        help="Directory containing upstream skill JSON reports (default: outputs/reports/trading/)",
    )
    parser.add_argument(
        "--output-dir", default="outputs/reports/trading/", help="Directory for output reports (default: outputs/reports/trading/)"
    )
    parser.add_argument(
        "--max-age",
        type=float,
