...
description: >-
  End-to-end UI design quality pipeline orchestrating 6 design skills across
  3 phases: Prepare, Review (parallel 3-agent), and Fix. Composite pattern
  combining Pipeline with Fan-out/Fan-in.
metadata:
  author: thaki
  version: "1.1.0"
  category: harness
  pattern: composite (pipeline + fan-out/fan-in)
  origin: google-labs-code/stitch-skills
---
