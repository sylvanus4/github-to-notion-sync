...
description: >
  ...
  use for individual support operations (invoke kwp-customer-support-* directly).
  Do NOT use for sales outreach (use sales-harness).
tags: [harness, customer-support, orchestrator, pipeline, supervisor, escalation]
triggers:
  ...
  - "지원 파이프라인"
do_not_use:
  - "For individual support skill operations (invoke kwp-customer-support-* directly)"
  - "For sales outreach or lead management (use sales-harness)"
  - "For internal engineering incidents (use incident-to-improvement)"
  - "For general Slack messaging (use kwp-slack-slack-messaging)"
composes:
