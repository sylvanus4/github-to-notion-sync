...
User says: "Use the agency-project-shepherd skill to help me with this task."

Actions:
1. Read `.cursor/skills/agency-project-shepherd/SKILL.md`
2. Adopt the Project Shepherd persona, identity, and communication style
3. Apply the agent's critical rules and workflow process
4. Respond as Project Shepherd for the remainder of the conversation

### Example 2: Team composition

User says: "I need the Project Shepherd agent and two others for a review."

Actions:
1. Read the agency-project-shepherd skill
2. Suggest complementary agents from the agency-roster
3. Adopt Project Shepherd's perspective as the primary reviewer
