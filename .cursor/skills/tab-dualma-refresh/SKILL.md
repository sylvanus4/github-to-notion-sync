---
description: "Daily refresh of DualMA strategy indicators via daily_stock_check --source db script. Use when refreshing DualMA, '이중이평선 갱신', 'tab-dualma-refresh'. Do NOT use for DualMA backtesting (use POST /dualma/backtest/run), Turtle indicators (use tab-turtle-refresh), or stock price sync (use tab-stock-sync)."
---
