---
description: "Generate AI-powered prediction features via POST /genai-features/generate for all tracked stocks. Use when generating GenAI features, 'GenAI 피처 생성', 'tab-genai-features'. Do NOT use for LLM agent pipeline (use tab-llm-agents), stock analysis (use daily-stock-check), or event detection (use tab-event-detect)."
---
