...
### Input
Your task is to analyze user feedback data for **{product}** and identify market segments with associated sentiment insights.
...
- What this segment loves about {product}
...
- How well {product} serves this segment's needs
