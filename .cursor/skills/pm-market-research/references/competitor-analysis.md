...
### Input
Your task is to analyze the competitive landscape for **{product}** in the **[market/industry segment]** (if specified).
...
1. **Market Scoping**: Define the market, industry, and addressable customer base for {product}
...
5. **Differentiation Mapping**: Identify gaps, overlaps, and opportunities for {product} to differentiate
...
- Recommended competitive positioning for {product}
