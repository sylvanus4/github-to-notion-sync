...
- Notion (if connected): product docs, runbooks, FAQs
- Google Drive: internal documents, specs, guides, past research
- HubSpot notes: previous answers to similar questions, account context
...
- Intercom (if connected): check if this has been asked/resolved before
