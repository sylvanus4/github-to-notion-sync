...
- **Linear** — tasks assigned, completed, commented on
- **HubSpot** — opportunity updates, account activity
...
- Google Drive: "Aurora API Spec v3" updated by Sarah (Wednesday)
- Linear: 3 tasks moved to In Progress, 2 completed

## Budget Planning
- Gmail: Finance team requesting Q2 projections by Friday
- Slack: Todd shared template in #finance (Monday)
- Google Drive: "Q2 Budget Template" shared with you (Monday)
```
