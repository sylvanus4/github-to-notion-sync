...
- **Intercom**: Search for similar open or recently resolved tickets
- **Notion**: Check for known issues or existing documentation
- **Linear**: Check if there's an existing bug report or feature request
