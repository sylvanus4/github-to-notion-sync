...
- @cmd-productivity-update to sync tasks and check memory
- @cmd-productivity-update --comprehensive for a deep scan of all activity
```
...
Use @cmd-productivity-update to keep things current (add --comprehensive for a deep scan).
```
