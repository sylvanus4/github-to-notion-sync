...
```bash
@cmd-productivity-update
@cmd-productivity-update --comprehensive
```
...
Read `TASKS.md` and `memory/` directory. If they don't exist, suggest `@cmd-productivity-start` first.
