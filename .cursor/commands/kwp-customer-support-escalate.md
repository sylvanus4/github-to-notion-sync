...
- **Intercom**: Related tickets, timeline of communications, previous troubleshooting
- **HubSpot** (if connected): Account details, key contacts, previous escalations
- **Slack**: Internal discussions about this issue, similar reports from other customers
- **Linear** (if connected): Related bug reports or feature requests, engineering status
- **Notion**: Known issues or workarounds, relevant documentation
...
- "Want me to post this in a Slack channel for the target team?"
