## KWP Product Management: Synthesize Research
...
- **Intercom** (if connected): Pull recent support tickets, feature requests, bug reports
- **Amplitude** (if connected): Pull usage data, funnel metrics, behavioral data
- **Fireflies** (if connected): Pull interview recordings, meeting summaries, and discussion notes
