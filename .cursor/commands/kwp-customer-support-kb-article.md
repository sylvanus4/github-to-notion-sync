## KWP Customer Support: Kb Article
...
- **Intercom**: Pull the ticket thread, resolution, and any internal notes
- **Notion**: Check if a similar article already exists (update vs. create new)
- **Linear**: Check if there's a related bug or feature request
...
- "Want me to check if a similar article already exists in your Notion?"
